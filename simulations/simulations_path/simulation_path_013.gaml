...
global {
	...
	reflex end_simulation when : ( cycle*step > 4*3600 ){
		do pause;
	}
...
experiment path_batch_013  type:batch repeat:6 until: ( cycle*step > 4*3600 ) {    
     // Pedestrian params
	...
	parameter "Nb cops per subroad" var:P_path_n_cops_per_subroad init:10;
