...
experiment path_manual_gui  benchmark:false type:gui until:(cycle*step>3*3600){    
     // Pedestrian params
	...
	parameter "Liking k param (time)" var: P_rioter_k_liking init:1.0; // To TUNE OK, 1h tension before being divided by two when feeling fear and sadness from police officers
	...
	parameter "Shoul detect surround" var:P_surround_to_detect init:false; // fixed (useless as is, interesting emotion after)
