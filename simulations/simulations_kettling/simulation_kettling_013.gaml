...
experiment kettling_batch_013 type: batch repeat:6 until: ( cycle*step > 4*3600 ) {  // 4h simulation
    // Pedestrian params
	...
	// General protest configuration
	parameter "Use damageable items" var:P_use_damageable_items init:false;
