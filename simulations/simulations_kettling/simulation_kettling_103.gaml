...
experiment kettling_batch_103 type: batch repeat:6 until: ( cycle*step > 4*3600 ) {  // 4h simulation
    // Pedestrian params
	...
	parameter "Emotional contagion activated" var: P_emotional_contagion_activated init:false; // TO VARY
	...
	parameter "Nb cops transverse" var:P_kettling_n_transverse_cops init:20;
