...
experiment kettling_batch_4 type: batch repeat:6 until: ( cycle*step > 4*3600 ) {  // 4h simulation
    // Pedestrian params
	...
	parameter "Nb cops transverse" var:P_kettling_n_transverse_cops init:24;
